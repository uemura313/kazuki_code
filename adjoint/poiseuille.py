...
# ==========================================
# Forward Fields (Artificial Shear Flow State)
# ==========================================
fwd_fields = [
...
# Setup artificial base state (satisfies BCs, but not Boussinesq eq)
z_grid = dist.local_grid(zbasis)
u['g'][0] = 0.1 * np.sin(np.pi * z_grid / Lz)  # u_x: Artificial shear flow
u['g'][1] = 0.0                                # u_z: Zero vertical velocity
b['g'] = Lz - z_grid                           # b: Linear temperature
p['g'] = 0.0

logger.info("  Set forward state to Artificial Shear Flow.")
