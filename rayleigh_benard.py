...
def run_dns(run_duration=50.0, timestep=0.125, Rayleigh=1e4, Prandtl=1, Lx=2, Lz=1, Nx=128, Nz=64, restart_file=None):
...
if __name__ == '__main__':
    solver1, _, _ = run_dns(run_duration=20.0)
    checkpoint_file = 'checkpoints/checkpoints_s1.h5'

    #solver2, _, _ = run_dns(run_duration=1.0, restart_file=checkpoint_file)
